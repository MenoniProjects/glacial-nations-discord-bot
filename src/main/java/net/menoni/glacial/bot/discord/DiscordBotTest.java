...
public class DiscordBotTest extends DiscordBot {
	...
	public DiscordBotTest(DiscordBotConfig config, AutowireCapableBeanFactory autowireCapableBeanFactory, String vtmBotVersion) throws InterruptedException {
		super(config, autowireCapableBeanFactory, vtmBotVersion);
	}
